...
import { ReactNode, Ref, Key } from 'react';
...
interface Properties$1<TLength = (string & {}) | 0, TTime = string & {}> extends StandardProperties<TLength, TTime>, VendorProperties<TLength, TTime>, ObsoleteProperties<TLength, TTime>, SvgProperties<TLength, TTime> {
}
...
declare namespace Property {
    ...
    type ScrollbarColor = Globals | DataType.Color | "auto";
    ...
    type MozForceBrokenImageIcon = Globals | 0 | 1;
...
declare const $intent$1: unique symbol;
declare const $intents: unique symbol;
...
interface IntentMap {
    [$intents]: Map<symbol, unknown>;
}
declare type DistributiveKeyof$1<T> = T extends T ? keyof T : never;
declare type Merge$2<P1, P2> = Omit<P1, DistributiveKeyof$1<P2>> & P2;
declare const $cssValue$2: unique symbol;
declare type FlattenArray$1<T> = T extends readonly any[] ? T[number] : T;
declare type FlattenVariants$1<T, Keys extends string | number | symbol = DistributiveKeyof$1<T>> = {
    [K in Keys]: T extends {
        [_K in K]?: any;
    } ? FlattenArray$1<T[K]> : never;
};
declare type InferComplexVariants$1<T> = [T] extends [string] ? never : [T] extends [readonly any[]] ? FlattenVariants$1<Exclude<T[number], string>> : {
    [K in keyof T]: FlattenArray$1<T[K]>;
};
interface SerializedStylesShape$1<Variants> {
    classes: string;
    dependencies: string[];
    inserted: boolean;
    key: string;
...
interface SerializedStyles$1<Variants> extends SerializedStylesShape$1<Variants>, Intent$1 {
}
declare type WithTrue$1<T> = T extends 'true' ? true | Exclude<T, 'true'> : T;
declare type WithFalse$1<T> = T extends 'false' ? false | Exclude<T, 'false'> : T;
declare type WithBooleans$1<T> = WithTrue$1<WithFalse$1<T>>;
declare type CssVariantAssignment$1<Variants> = keyof Variants extends never ? never : {
    [K in keyof Variants]?: ItemOrArray$1<WithBooleans$1<keyof Variants[K]>>;
};
declare type CssVariantRecord$1<T, Value> = {
    [Property in keyof T]: {
        [Variant in keyof T[Property]]: Value;
    };
};
declare type VariantProps$1<T> = {
    [K in keyof T]?: keyof T[K];
};
declare type CssVariants$1<T, Inherited = {}> = {
    assign(values?: CssVariantAssignment$1<T>): Intent$1;
    is(values?: CssVariantAssignment$1<T>): string[];
    id: string;
    selector: string;
    Props: VariantProps$1<T>;
} & CssVariantRecord$1<Inherited & T, `& (variant selector string)`>;
declare type CssPartialTokenRecord$1<T, Value> = {
    [Property in keyof T]?: {
        [Token in keyof T[Property]]?: Value;
    };
};
declare type CssTokenRecord$1<T, Value> = {
    [Property in keyof T]: {
        [Token in keyof T[Property]]: Value;
    };
};
declare type CssTokens$1<T> = {
    assign(values: CssPartialTokenRecord$1<T, string | number> | null): Intent$1;
} & CssTokenRecord$1<T, string>;
interface CssValue$2<T> {
    [$cssValue$2]: boolean;
    value: T;
    toString(): T;
}
declare type CssProperties$1 = {
    [K in keyof Properties$1]: CssValue$2<Exclude<Properties$1[K], undefined>>;
} & {
    [customProperty: `--${string}`]: CssValue$2<string | number> | undefined;
};
interface CssPlugin$1<Value, Properties> {
    (value: Value): Properties;
}
interface CssPluginsShape$1<Properties = unknown> {
    [property: string]: CssPlugin$1<any, Properties>;
}
interface CssVariantsShape$1<Value = string | boolean | null | undefined> {
    [property: string]: {
        [variant: string]: Value;
    };
}
interface CssTokensShape$1<Value = string | number> {
    [scale: string]: {
        [token: string]: Value;
    };
}
interface CssAliasShape$1<Tokens> {
    [property: string]: keyof Tokens;
}
declare type CssPropertyValue$1<Properties, Plugins, K> = K extends keyof Plugins ? Plugins[K] extends CssPlugin$1<infer Value, Properties> ? Value : never : K extends keyof Properties ? Properties[K] : never;
declare type CssAliasValue$1<Tokens, Alias, K> = K extends keyof Alias ? Alias[K] extends infer A ? A extends keyof Tokens ? keyof Tokens[A] : never : never : never;
declare type CssNestedProperties$1<T> = T & {
    [selector: `@nest ${string}` | `&${string}` | `:global ${string}`]: CssNestedProperties$1<T>;
};
declare type ItemOrArray$1<T> = T | T[];
declare type SharedProperties$1<Variants> = {
    dependencies?: string[];
    /** @deprecated Use nested styles instead */
    when?: ItemOrArray$1<string | (keyof Variants extends never ? never : {
        [K in keyof Variants]?: ItemOrArray$1<keyof Variants[K]>;
    })>;
};
declare type CssComputeProperties$1<Variants, Properties, Plugins, Tokens, Alias> = CssNestedProperties$1<{
    [K in keyof Properties | keyof Plugins | keyof Alias]?: CssPropertyValue$1<Properties, Plugins, K> | CssAliasValue$1<Tokens, Alias, K>;
}> & SharedProperties$1<Variants>;
interface CssSerializerOptions$1<Variants, Plugins, Tokens, Alias> {
    alias: Alias;
    variants: Variants;
    layer: string;
    plugins: Plugins;
...
declare type Merge$1<A, B> = {
    [K in keyof A | keyof B]: K extends keyof B ? B[K] : K extends keyof A ? A[K] : never;
};
interface CssSerializer$1<Properties, Variants extends CssVariantsShape$1, Plugins extends CssPluginsShape$1, Tokens extends CssTokensShape$1, Alias extends CssAliasShape$1<Tokens>, ComputedProperties = CssComputeProperties$1<Variants, Properties, Plugins, Tokens, Alias>> {
    <V>(...properties: (ComputedProperties & {
        variants?: V;
    })[]): SerializedStyles$1<InferComplexVariants$1<V>>;
    configure<Pr = Properties, Co extends CssVariantsShape$1 = {}, Pl extends CssPluginsShape$1<Pr> = {}, To extends CssTokensShape$1 = {}, Al extends CssAliasShape$1<Merge$1<Tokens, To>> = {}>(options?: Partial<CssSerializerOptions$1<Co, Pl, To, Al>> | ((css: CssSerializer$1<Properties, Variants, Plugins, Tokens, Alias, ComputedProperties>) => Partial<CssSerializerOptions$1<Co, Pl, To, Al>>)): CssSerializer$1<Pr, Merge$1<Variants, Co>, Merge$1<Plugins, Pl>, Merge$1<Tokens, To>, Omit<Alias, keyof Al> & Al>;
    options: CssSerializerOptions$1<Variants, Plugins, Tokens, Alias>;
    value<T>(input: T): CssValue$2<T>;
    variants: CssVariants$1<Variants>;
    token: CssTokens$1<Tokens>;
    Alias: Alias;
...
declare type ShadowValue$1 = CssProperties$1['boxShadow'];
interface ShadowResult$1 {
    [key: `--${string}`]: ShadowValue$1;
    transform?: ShadowValue$1;
}
interface ShadowPlugin$1 {
    (value: ShadowValue$1): ShadowResult$1;
}
declare type AlignX$1 = 'start' | 'center' | 'end';
declare type AlignY$1 = 'top' | 'center' | 'baseline' | 'bottom';
declare type Layout$1 = 'column' | 'row' | 'inline' | 'inline-column' | 'inline-row';
declare type GapValue$1 = CssProperties$1['gap'];
interface GapResult$1 {
    [key: `--${string}`]: GapValue$1;
    gap?: GapValue$1;
}
interface GapPlugin$1 {
    (value: GapValue$1): GapResult$1;
}
declare type TransformValue$1 = CssProperties$1['transform'];
interface TransformResult$1 {
    [key: `--${string}`]: TransformValue$1;
    transform?: TransformValue$1;
}
interface TransformPlugin$1 {
    (value: TransformValue$1): TransformResult$1;
}
declare const $as: unique symbol;
declare const $extends: unique symbol;
declare const $render: unique symbol;
declare type SlotsRecord<T> = [T] extends [string] ? {
...
declare type DefaultInstanceProps = Pick<React$1.HTMLAttributes<Element>, keyof React$1.HTMLAttributes<Element> & keyof React$1.SVGAttributes<Element>>;
declare type InstanceProps<Props, Instance> = Merge$2<SharedProps & (Instance extends keyof JSX.IntrinsicElements ? JSX.IntrinsicElements[Instance] : DefaultInstanceProps), Props>;
interface SharedProps extends NotIntent {
    children?: React$1.ReactNode;
    key?: React$1.Key | null | undefined;
    slot?: string;
}
interface AdditionalInternalProps extends SharedProps, IntentMap {
}
declare type InternalProps<MergedProps = DefaultInstanceProps> = MergedProps & AdditionalInternalProps;
declare type AbstractComponent = Component<unknown, undefined, undefined, undefined>;
interface Render<MergedProps, MergedSlots, ExtendedView> {
    (props: InternalProps<MergedProps> & MergedSlots, View: ExtendedView): React$1.ReactNode;
}
interface AdditionalExternalProps<MergedProps, Styles> {
    css?: Styles;
    ref?: MergedProps extends {
        ref?: infer T;
    } ? T : React$1.LegacyRef<Element> | React$1.LegacyRef<HTMLElement> | React$1.LegacyRef<SVGElement>;
}
declare type ExternalProps<MergedProps = DefaultInstanceProps, Styles = undefined> = MergedProps & AdditionalExternalProps<MergedProps, Styles>;
interface CreateView<Props, Instance, Slots, Styles> {
    <P = Props, S = Slots>(render: Render<InstanceProps<P, Instance>, SlotsRecord<S>, Component<Props, Instance, Slots, Styles>>): Component<P, Instance, S, Styles>;
}
interface ExtendView<Props, Instance, Slots, Styles, ExtendedView> {
    <P = Props, S = Slots>(intents: (props: InstanceProps<P, Instance> & SlotsRecord<S>, View: ExtendedView) => JSX.Element & {
        type: ExtendedView;
    }): Component<P, Instance, S, Styles>;
}
declare type RemoveIntents<T, Props> = T extends Intent$1 ? never : T extends Intent$1<Props> ? never : T;
declare type FlattenProps<P, Props> = Omit<P, 'uses'> | (P extends {
    uses: infer U;
} ? U extends any[] ? RemoveIntents<U[number], Props> : never : never);
declare type PropsShape<Props, MergedProps> = MergedProps & {
    uses?: (Intent$1 | Intent$1<Props> | Partial<MergedProps> | null)[];
};
interface ExternalComponent<Props, MergedProps> {
    <P extends PropsShape<Props, MergedProps>>(props: P & {
        [K in DistributiveKeyof$1<FlattenProps<P, Props>> as K extends DistributiveKeyof$1<MergedProps & {
            [data: `data-${string}`]: string | boolean | number | undefined;
        }> ? never : K]: never;
    }): JSX.Element;
}
declare type Serializer<ComputedProperties> = CssSerializer$1<{}, {}, {}, {}, {}, ComputedProperties>;
interface InternalComponent<Props, Instance, Slots, Styles, MergedProps, MergedSlots> extends ExternalComponent<Props, ExternalProps<MergedProps, Styles>> {
    displayName?: string;
    [$as]: Instance | undefined;
    [$extends]: AbstractComponent | undefined;
    [$render]: Render<MergedProps, MergedSlots, AbstractComponent>;
    as<I>(tag: I): Component<Props, I, Slots, Styles>;
    styles<T>(css: Serializer<T>): Component<Props, Instance, Slots, T>;
    create: CreateView<Props, Instance, Slots, Styles>;
    extend: ExtendView<Props, Instance, Slots, Styles, Component<Props, Instance, Slots, Styles>>;
}
declare type Component<Props, Instance, Slots, Styles> = InternalComponent<Props, Instance, Slots, Styles, InstanceProps<Props, Instance> & Partial<IntentMap>, SlotsRecord<Slots>>;
declare type StylisExtensionData$2 = {
    [key: string]: unknown;
};
declare module 'stylis' {
    interface Element {
        data?: StylisExtensionData$2;
    }
}
...
declare type PointerType = 'mouse' | 'pen' | 'touch' | 'keyboard' | 'virtual';
...
declare type ActionProps = PressEvents & {
    disabled?: boolean;
    /**
    ...
    /**
     * Whether the action should receive events forwarded from a specific ancestor.
     */
    receiver?: boolean;
} & ({
    /**
...
interface BadgeProps$1 {
     ...
     * @external
     */
    type?: 'urgent' | 'warning' | 'negative' | 'positive' | 'info' | 'neutral';
}
/**
 * @external
 */
declare const Badge: Component<BadgeProps$1, "span", undefined, undefined>;
declare type ButtonProps$1 = {
    /**
 ...
 * @param target
 */
declare const Button: Component<ButtonProps$1, "a", undefined, CssComputeProperties$1<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
    ...
    layout: (value: Layout$1) => CssNestedProperties$1<Pick<CssProperties$1, "alignItems" | "alignSelf" | "display" | "flexDirection" | "justifyContent" | "justifySelf">>;
    x: TransformPlugin$1;
    y: TransformPlugin$1;
    boxShadow: ShadowPlugin$1;
    rotate: TransformPlugin$1;
    scale: TransformPlugin$1;
    transform: TransformPlugin$1;
    font: CssPlugin$1<"caption" | "body" | "title" | "heading" | "subtitle" | "subheading" | "lead" | "kicker" | "bodyEmphasized" | CssValue$2<Property.Font> | undefined, CssProperties$1>;
    gap: GapPlugin$1;
    alignSelfX: (value: AlignX$1) => {
        '--align-self-x'?: CssValue$2<string> | undefined;
    };
    alignSelfY: (value: AlignY$1) => {
        '--align-self-y'?: CssValue$2<string> | undefined;
    };
    alignX: (value: AlignX$1) => {
        '--align-x'?: CssValue$2<string> | undefined;
    };
    alignY: (value: AlignY$1) => {
        '--align-y'?: CssValue$2<string> | undefined;
    };
    gapX: GapPlugin$1;
    gapY: GapPlugin$1;
    topShadow: ShadowPlugin$1;
    focusRing: ShadowPlugin$1;
    keyline: ShadowPlugin$1;
    keylineWidth: (val: CssValue$2<Property.BorderWidth<0 | (string & {})>> | undefined) => {
        [key: `--${string}`]: CssValue$2<Property.BorderWidth<0 | (string & {})>> | undefined;
    };
    marginX: (value: CssValue$2<Property.MarginLeft<0 | (string & {})>> | undefined) => Pick<CssProperties$1, "marginLeft" | "marginRight">;
    marginY: (value: CssValue$2<Property.MarginTop<0 | (string & {})>> | undefined) => Pick<CssProperties$1, "marginBottom" | "marginTop">;
    paddingX: (value: CssValue$2<Property.PaddingLeft<0 | (string & {})>> | undefined) => Pick<CssProperties$1, "paddingLeft" | "paddingRight">;
    paddingY: (value: CssValue$2<Property.PaddingTop<0 | (string & {})>> | undefined) => Pick<CssProperties$1, "paddingBottom" | "paddingTop">;
}, {
    color: {
        neutral0: string;
        neutral50: string;
...
}, Omit<Omit<{}, "backgroundColor" | "borderColor" | "zIndex" | "color" | "left" | "right" | "bottom" | "top" | "inset" | "fill" | "borderBottomColor" | "borderBottomLeftRadius" | "borderBottomRightRadius" | "borderLeftColor" | "borderRightColor" | "borderTopColor" | "borderTopLeftRadius" | "borderTopRightRadius" | "boxShadow" | "columnGap" | "fontFamily" | "fontWeight" | "height" | "marginBottom" | "marginLeft" | "marginRight" | "marginTop" | "maxHeight" | "maxWidth" | "minHeight" | "minWidth" | "paddingBottom" | "paddingLeft" | "paddingRight" | "paddingTop" | "rowGap" | "width" | "padding" | "background" | "borderRadius" | "gap" | "margin" | "gapX" | "gapY" | "topShadow" | "focusRing" | "keyline" | "marginX" | "marginY" | "paddingX" | "paddingY"> & {
    zIndex: "zIndex";
    fontFamily: "typeface";
    fontWeight: "weight";
    marginX: "space";
...
interface ButtonGroupProps$1 {
    ...
    /**
     * The contents of the button group. Each child must support press events.
     * @external
     */
    children: ReactNode;
}
 ...
 * @external
 */
declare const ButtonGroup: Component<ButtonGroupProps$1, "div", undefined, CssComputeProperties$1<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
...
interface ToggleableProps {
    /**
     * Sets whether or the element is checked or not, for controlled use cases. Should be used in conjunction with `onChange`.
     * @external
     */
    checked?: boolean;
    /**
     * Sets whether or not the element should be disabled. Prevents toggling in both controlled and uncontrolled situations.
     * @external
     */
    disabled?: boolean;
    /**
     * Function to call when the element's value changes. Will not fire if the element is disabled.
     * @external
     */
...
declare type ControlProps = {
    ...
    error?: string;
    /**
     * ref that attaches to the outermost element of the control.
     * @external
     */
...
declare type SubsetOfKeys<T, U extends keyof T> = U;
declare type FormFieldElements = SubsetOfKeys<ControlProps, 'error' | 'description' | 'label'>;
/**
 * @external
 * @param autofocus
 * @param checked
 ...
 * @param value
 */
declare const Checkbox: Component<ControlProps & ToggleableProps & {
    /**
...
declare type FormFieldGroupProps$1 = {
    /**
     * @external
 ...
 * @param form
 */
declare const FormFieldGroup: Component<FormFieldGroupProps$1, "div", undefined, CssComputeProperties$1<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
 ...
 * @param target
 */
declare const Link: Component<LinkProps$1, "a", undefined, CssComputeProperties$1<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
...
interface MenuTriggerProps$1 {
    /**
     * The element to trigger opening the menu and the menu itself.
     * The trigger should be an element that supports press events
     * @external
     */
    children: [ReactNode, ReactNode];
}
interface MenuProps$1 extends AriaLabelingProps {
    /**
...
/** @external */
declare const Menu: Component<MenuProps$1, "ul", undefined, undefined>;
/** @external */
declare const MenuItem: (props: MenuItemProps$1) => JSX.Element;
/** @external */
declare const MenuGroup: (props: MenuGroupProps$1) => JSX.Element;
declare type Slots = 'default' | 'menu';
/** @external */
declare const MenuTrigger: Component<MenuTriggerProps$1, undefined, Slots, undefined>;
interface NoticeProps$1 {
    /**
     * @external
     */
    type?: 'attention' | 'positive' | 'negative' | 'neutral';
 ...
 * @external
 */
declare const Notice: Component<NoticeProps$1, "span", undefined, CssComputeProperties$1<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
...
declare type NativeRadioProps = {
    /**
     * Sets whether or the Radio is checked or not, for controlled use cases. Should be used in conjunction with `onClick`.
     * @external
     */
    checked?: boolean;
    /**
    ...
    name?: string;
    /**
     * Sets whether or not the Radio should be disabled. Prevents toggling in both controlled and uncontrolled situations.
     * @external
     */
    disabled?: boolean;
    /**
     * Sets whether or not the element is in an invalid state.
     * @external
     */
    invalid?: boolean;
};
 ...
 * @param value
 */
declare const Radio: Component<ControlProps & NativeRadioProps, "input", undefined, CssComputeProperties$1<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
 ...
 * @param size
 */
declare const Select: Component<ControlProps & NativeSelectProps, "select", undefined, CssComputeProperties$1<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
 ...
 * @param value
 */
declare const Switch: Component<ControlProps & ToggleableProps, "input", undefined, undefined>;
declare type TableCellAlign = 'center' | 'left' | 'right';
declare type TableCellVAlign = 'baseline' | 'bottom' | 'middle' | 'top';
declare type TableCellWidth = 'auto' | 'maximized' | 'minimized' | number;
declare type TableCellProps$1 = {
    /** @external */
    align?: TableCellAlign;
    /** @external */
    colSpan?: number;
    /** @external */
    contentUses?: Intent$1[];
    /** @external */
...
/** @external */
declare const Table: Component<unknown, "table", undefined, undefined>;
/** @external */
declare const TableHead: Component<unknown, "thead", undefined, undefined>;
/** @external */
declare const TableBody: Component<unknown, "tbody", undefined, undefined>;
/** @external */
declare const TableRow: Component<unknown, "tr", undefined, undefined>;
/** @external */
declare const TableFooter: Component<unknown, "tfoot", undefined, undefined>;
/** @external */
declare const TableCell: Component<TableCellProps$1, undefined, undefined, undefined>;
/** @external */
declare const TableHeaderCell: Component<TableCellProps$1, string, undefined, undefined>;
declare type NativeTextAreaProps = {
    /**
 ...
 * @param wrap
 */
declare const TextArea: Component<ControlProps & NativeTextAreaProps, "textarea", undefined, CssComputeProperties$1<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
...
declare type NativeTextFieldProps = {
    /**
     * Programmatically mark the value as invalid
     * @external
     */
 ...
 * @param value
 */
declare const TextField: Component<ControlProps & NativeTextFieldProps, "input", undefined, CssComputeProperties$1<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
 ...
 * @param key
 */
declare const ListItem: (props: ItemProps) => JSX.Element;
/** @external */
declare const List: Component<{
     ...
     * @external
     */
    onAction?: ((key: React$1.Key) => void) | undefined;
}, "div", undefined, CssComputeProperties$1<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
...
declare const $intent: unique symbol;
interface Intent<T = unknown> {
    shape?: T;
    [$intent]: symbol;
}
declare type DistributiveKeyof<T> = T extends T ? keyof T : never;
declare const $cssValue$1: unique symbol;
declare type FlattenArray<T> = T extends readonly any[] ? T[number] : T;
declare type FlattenVariants<T, Keys extends string | number | symbol = DistributiveKeyof<T>> = {
    [K in Keys]: T extends {
        [_K in K]?: any;
    } ? FlattenArray<T[K]> : never;
};
declare type InferComplexVariants<T> = [T] extends [string] ? never : [T] extends [readonly any[]] ? FlattenVariants<Exclude<T[number], string>> : {
    [K in keyof T]: FlattenArray<T[K]>;
};
interface SerializedStylesShape<Variants> {
    classes: string;
    dependencies: string[];
    inserted: boolean;
    key: string;
...
interface SerializedStyles<Variants> extends SerializedStylesShape<Variants>, Intent {
}
declare type WithTrue<T> = T extends 'true' ? true | Exclude<T, 'true'> : T;
declare type WithFalse<T> = T extends 'false' ? false | Exclude<T, 'false'> : T;
declare type WithBooleans<T> = WithTrue<WithFalse<T>>;
declare type CssVariantAssignment<Variants> = keyof Variants extends never ? never : {
    [K in keyof Variants]?: ItemOrArray<WithBooleans<keyof Variants[K]>>;
};
declare type CssVariantRecord<T, Value> = {
    [Property in keyof T]: {
        [Variant in keyof T[Property]]: Value;
    };
};
declare type VariantProps<T> = {
    [K in keyof T]?: keyof T[K];
};
declare type CssVariants<T, Inherited = {}> = {
    assign(values?: CssVariantAssignment<T>): Intent;
    is(values?: CssVariantAssignment<T>): string[];
    id: string;
    selector: string;
    Props: VariantProps<T>;
} & CssVariantRecord<Inherited & T, `& (variant selector string)`>;
declare type CssPartialTokenRecord<T, Value> = {
    [Property in keyof T]?: {
        [Token in keyof T[Property]]?: Value;
    };
};
declare type CssTokenRecord<T, Value> = {
    [Property in keyof T]: {
        [Token in keyof T[Property]]: Value;
    };
};
declare type CssTokens<T> = {
    assign(values: CssPartialTokenRecord<T, string | number> | null): Intent;
} & CssTokenRecord<T, string>;
interface CssValue$1<T> {
    [$cssValue$1]: boolean;
    value: T;
    toString(): T;
}
declare type CssProperties = {
    [K in keyof Properties$1]: CssValue$1<Exclude<Properties$1[K], undefined>>;
} & {
    [customProperty: `--${string}`]: CssValue$1<string | number> | undefined;
};
interface CssPlugin<Value, Properties> {
    (value: Value): Properties;
}
interface CssPluginsShape<Properties = unknown> {
    [property: string]: CssPlugin<any, Properties>;
}
interface CssVariantsShape<Value = string | boolean | null | undefined> {
    [property: string]: {
        [variant: string]: Value;
    };
}
interface CssTokensShape<Value = string | number> {
    [scale: string]: {
        [token: string]: Value;
    };
}
interface CssAliasShape<Tokens> {
    [property: string]: keyof Tokens;
}
declare type CssPropertyValue<Properties, Plugins, K> = K extends keyof Plugins ? Plugins[K] extends CssPlugin<infer Value, Properties> ? Value : never : K extends keyof Properties ? Properties[K] : never;
declare type CssAliasValue<Tokens, Alias, K> = K extends keyof Alias ? Alias[K] extends infer A ? A extends keyof Tokens ? keyof Tokens[A] : never : never : never;
declare type CssNestedProperties<T> = T & {
    [selector: `@nest ${string}` | `&${string}` | `:global ${string}`]: CssNestedProperties<T>;
};
declare type ItemOrArray<T> = T | T[];
declare type SharedProperties<Variants> = {
    dependencies?: string[];
    /** @deprecated Use nested styles instead */
    when?: ItemOrArray<string | (keyof Variants extends never ? never : {
        [K in keyof Variants]?: ItemOrArray<keyof Variants[K]>;
    })>;
};
declare type CssComputeProperties<Variants, Properties, Plugins, Tokens, Alias> = CssNestedProperties<{
    [K in keyof Properties | keyof Plugins | keyof Alias]?: CssPropertyValue<Properties, Plugins, K> | CssAliasValue<Tokens, Alias, K>;
}> & SharedProperties<Variants>;
interface CssSerializerOptions<Variants, Plugins, Tokens, Alias> {
    alias: Alias;
    variants: Variants;
    layer: string;
    plugins: Plugins;
...
interface CssSerializer<Properties, Variants extends CssVariantsShape, Plugins extends CssPluginsShape, Tokens extends CssTokensShape, Alias extends CssAliasShape<Tokens>, ComputedProperties = CssComputeProperties<Variants, Properties, Plugins, Tokens, Alias>> {
    <V>(...properties: (ComputedProperties & {
        variants?: V;
    })[]): SerializedStyles<InferComplexVariants<V>>;
    configure<Pr = Properties, Co extends CssVariantsShape = {}, Pl extends CssPluginsShape<Pr> = {}, To extends CssTokensShape = {}, Al extends CssAliasShape<Merge<Tokens, To>> = {}>(options?: Partial<CssSerializerOptions<Co, Pl, To, Al>> | ((css: CssSerializer<Properties, Variants, Plugins, Tokens, Alias, ComputedProperties>) => Partial<CssSerializerOptions<Co, Pl, To, Al>>)): CssSerializer<Pr, Merge<Variants, Co>, Merge<Plugins, Pl>, Merge<Tokens, To>, Omit<Alias, keyof Al> & Al>;
    options: CssSerializerOptions<Variants, Plugins, Tokens, Alias>;
    value<T>(input: T): CssValue$1<T>;
    variants: CssVariants<Variants>;
    token: CssTokens<Tokens>;
    Alias: Alias;
    ComputedProperties: ComputedProperties;
    Variants: Variants;
    Tokens: Tokens;
...
declare type ShadowValue = CssProperties['boxShadow'];
interface ShadowResult {
    [key: `--${string}`]: ShadowValue;
    transform?: ShadowValue;
}
interface ShadowPlugin {
    (value: ShadowValue): ShadowResult;
}
declare type AlignX = 'start' | 'center' | 'end';
declare type AlignY = 'top' | 'center' | 'baseline' | 'bottom';
declare type Layout = 'column' | 'row' | 'inline' | 'inline-column' | 'inline-row';
declare type GapValue = CssProperties['gap'];
interface GapResult {
    [key: `--${string}`]: GapValue;
    gap?: GapValue;
}
interface GapPlugin {
    (value: GapValue): GapResult;
}
declare type TransformValue = CssProperties['transform'];
interface TransformResult {
    [key: `--${string}`]: TransformValue;
    transform?: TransformValue;
}
interface TransformPlugin {
    (value: TransformValue): TransformResult;
}
declare type StylisExtensionData$1 = {
    [key: string]: unknown;
};
declare module 'stylis' {
    interface Element {
        data?: StylisExtensionData$1;
    }
}
declare const css: CssSerializer<CssProperties, {
    pointer: {
        coarse: string;
        fine: string;
        none: string;
    ...
    layout: (value: Layout) => CssNestedProperties<Pick<CssProperties, "alignItems" | "alignSelf" | "display" | "flexDirection" | "justifyContent" | "justifySelf">>;
    x: TransformPlugin;
    y: TransformPlugin;
    boxShadow: ShadowPlugin;
    rotate: TransformPlugin;
    scale: TransformPlugin;
    transform: TransformPlugin;
    font: CssPlugin<"caption" | "body" | "title" | "heading" | "subtitle" | "subheading" | "lead" | "kicker" | "bodyEmphasized" | CssValue$1<Property.Font> | undefined, CssProperties>;
    gap: GapPlugin;
    alignSelfX: (value: AlignX) => {
        '--align-self-x'?: CssValue$1<string> | undefined;
    };
    alignSelfY: (value: AlignY) => {
        '--align-self-y'?: CssValue$1<string> | undefined;
    };
    alignX: (value: AlignX) => {
        '--align-x'?: CssValue$1<string> | undefined;
    };
    alignY: (value: AlignY) => {
        '--align-y'?: CssValue$1<string> | undefined;
    };
    gapX: GapPlugin;
    gapY: GapPlugin;
    topShadow: ShadowPlugin;
    focusRing: ShadowPlugin;
    keyline: ShadowPlugin;
    keylineWidth: (val: CssValue$1<Property.BorderWidth<0 | (string & {})>> | undefined) => {
        [key: `--${string}`]: CssValue$1<Property.BorderWidth<0 | (string & {})>> | undefined;
    };
    marginX: (value: CssValue$1<Property.MarginLeft<0 | (string & {})>> | undefined) => Pick<CssProperties, "marginLeft" | "marginRight">;
    marginY: (value: CssValue$1<Property.MarginTop<0 | (string & {})>> | undefined) => Pick<CssProperties, "marginBottom" | "marginTop">;
    paddingX: (value: CssValue$1<Property.PaddingLeft<0 | (string & {})>> | undefined) => Pick<CssProperties, "paddingLeft" | "paddingRight">;
    paddingY: (value: CssValue$1<Property.PaddingTop<0 | (string & {})>> | undefined) => Pick<CssProperties, "paddingBottom" | "paddingTop">;
}, {
    color: {
        neutral0: string;
        neutral50: string;
...
}, Omit<Omit<{}, "color" | "left" | "right" | "bottom" | "top" | "inset" | "fill" | "backgroundColor" | "borderBottomColor" | "borderBottomLeftRadius" | "borderBottomRightRadius" | "borderLeftColor" | "borderRightColor" | "borderTopColor" | "borderTopLeftRadius" | "borderTopRightRadius" | "boxShadow" | "columnGap" | "fontFamily" | "fontWeight" | "height" | "marginBottom" | "marginLeft" | "marginRight" | "marginTop" | "maxHeight" | "maxWidth" | "minHeight" | "minWidth" | "paddingBottom" | "paddingLeft" | "paddingRight" | "paddingTop" | "rowGap" | "width" | "zIndex" | "padding" | "background" | "borderColor" | "borderRadius" | "gap" | "margin" | "gapX" | "gapY" | "topShadow" | "focusRing" | "keyline" | "marginX" | "marginY" | "paddingX" | "paddingY"> & {
    zIndex: "zIndex";
    fontFamily: "typeface";
    fontWeight: "weight";
    marginX: "space";
...
declare const $cssValue: unique symbol;
interface CssValue<T> {
    [$cssValue]: boolean;
    value: T;
    toString(): T;
}
declare type StylisExtensionData = {
    [key: string]: unknown;
};
declare module 'stylis' {
    interface Element {
        data?: StylisExtensionData;
    }
}
declare type Properties = typeof css.ComputedProperties;
declare type TokenizedPropertiesUnfiltered = {
    [K in keyof Properties]?: Exclude<Properties[K], CssValue<any>>;
};
declare type TokenizedCSSProperties = {
    [K in keyof TokenizedPropertiesUnfiltered as Exclude<TokenizedPropertiesUnfiltered[K], undefined> extends never ? never : K]?: TokenizedPropertiesUnfiltered[K];
};
interface StylableProps {
    css?: TokenizedCSSProperties;
}
declare type ImpBadgeProps = React.ComponentProps<typeof Badge>;
interface BadgeProps {
    slot?: ImpBadgeProps["slot"];
    type?: ImpBadgeProps["type"];
}
declare type ImpButtonProps = React.ComponentProps<typeof Button>;
interface ButtonProps {
    slot?: ImpButtonProps["slot"];
    className?: ImpButtonProps["className"];
    id?: ImpButtonProps["id"];
    target?: ImpButtonProps["target"];
    /** The size of the button */
    size?: ImpButtonProps["size"];
    /** The type of the button */
    type?: ImpButtonProps["type"];
    /** Handler that is called when the press is released over the target. */
    onPress?: ImpButtonProps["onPress"];
    disabled?: ImpButtonProps["disabled"];
    /** Native `href` attribute */
    href?: ImpButtonProps["href"];
}
declare type ImpButtonGroupProps = React.ComponentProps<typeof ButtonGroup>;
interface ButtonGroupProps {
    slot?: ImpButtonGroupProps["slot"];
    /** Controls which axis the button group should span. */
    direction?: ImpButtonGroupProps["direction"];
    /** Controls whether or not buttons within the group collapse when there isn't enough space to display them without overflowing. */
    collapse?: ImpButtonGroupProps["collapse"];
    /** Allows overriding the trigger element used for an overflow menu. Must be a component that supports press events. */
    menuTrigger?: ImpButtonGroupProps["menuTrigger"];
    /** The contents of the button group. Each child must support press events. */
    children: ImpButtonGroupProps["children"];
}
declare type ImpCheckboxProps = React.ComponentProps<typeof Checkbox>;
interface CheckboxProps {
    form?: ImpCheckboxProps["form"];
    slot?: ImpCheckboxProps["slot"];
    defaultChecked?: ImpCheckboxProps["defaultChecked"];
    className?: ImpCheckboxProps["className"];
    id?: ImpCheckboxProps["id"];
    tabIndex?: ImpCheckboxProps["tabIndex"];
    name?: ImpCheckboxProps["name"];
    required?: ImpCheckboxProps["required"];
    value?: ImpCheckboxProps["value"];
    /** Visually hides the specified elements. The hidden elements will still be present and visible to screen readers. */
    hiddenElements?: ImpCheckboxProps["hiddenElements"];
    /** Descriptive text that will be rendered adjacent to the control's label. */
    description?: ImpCheckboxProps["description"];
    /** Error text that will be rendered below the control. */
    error?: ImpCheckboxProps["error"];
    /** ref that attaches to the outermost element of the control. */
    outerRef?: ImpCheckboxProps["outerRef"];
    /** Text that describes the control. Will be both visible and clickable. */
    label?: ImpCheckboxProps["label"];
    /** Text that describes the control. Only visible to screen readers, and is not clickable. Should not be used if `label` is set. */
    "aria-label"?: ImpCheckboxProps["aria-label"];
    /** Sets whether or the element is checked or not, for controlled use cases. Should be used in conjunction with `onChange`. */
    checked?: ImpCheckboxProps["checked"];
    /** Sets whether or not the element should be disabled. Prevents toggling in both controlled and uncontrolled situations. */
    disabled?: ImpCheckboxProps["disabled"];
    /** Function to call when the element's value changes. Will not fire if the element is disabled. */
    onChange?: ImpCheckboxProps["onChange"];
    /** Sets whether or not the element is in an invalid state. This is a display-only prop, and will not prevent form submission. */
    invalid?: ImpCheckboxProps["invalid"];
    /** Sets whether the Checkbox should be rendered as indeterminate ("partially checked") or not. Note that this is purely visual, and will not change the actual `checked` state of the Checkbox. If a Checkbox is both `indeterminate` and `checked`, it will display as `indeterminate`. */
    indeterminate?: ImpCheckboxProps["indeterminate"];
}
interface DividerProps {
}
declare type ImpFormFieldGroupProps = React.ComponentProps<typeof FormFieldGroup>;
interface FormFieldGroupProps {
    slot?: ImpFormFieldGroupProps["slot"];
    layout?: ImpFormFieldGroupProps["layout"];
    legend?: ImpFormFieldGroupProps["legend"];
    disabled?: ImpFormFieldGroupProps["disabled"];
    /** Descriptive text that will be rendered adjacent to the group's legend. */
    description?: ImpFormFieldGroupProps["description"];
    /** Marks the group as invalid. Note that this is a visual-only property, and won't prevent submission. */
    invalid?: ImpFormFieldGroupProps["invalid"];
}
declare type ImpLinkProps = React.ComponentProps<typeof Link>;
interface LinkProps {
    slot?: ImpLinkProps["slot"];
    className?: ImpLinkProps["className"];
    id?: ImpLinkProps["id"];
    tabIndex?: ImpLinkProps["tabIndex"];
    target?: ImpLinkProps["target"];
    rel?: ImpLinkProps["rel"];
    /** The type of the link */
    type?: ImpLinkProps["type"];
    /** Handler that is called when the press is released over the target. */
    onPress?: ImpLinkProps["onPress"];
    /** Native `href` attribute */
    href?: ImpLinkProps["href"];
}
declare type ImpMenuProps = React.ComponentProps<typeof Menu>;
interface MenuProps {
    slot?: ImpMenuProps["slot"];
    /** Handler that is called when an item is selected. */
    onAction?: ImpMenuProps["onAction"];
}
declare type ImpMenuItemProps = React.ComponentProps<typeof MenuItem>;
interface MenuItemProps {
    /** Handler that is called when an item is selected. */
    onAction?: ImpMenuItemProps["onAction"];
    /** The id of the item. This will be passed into the `onAction` handler of `Menu` */
    id?: ImpMenuItemProps["id"];
    /** Marks an item as disabled. Disabled items cannot be selected, focused, or otherwise interacted with. */
    disabled?: ImpMenuItemProps["disabled"];
    /** An accessibility label for this item. */
    "aria-label"?: ImpMenuItemProps["aria-label"];
}
declare type ImpMenuGroupProps = React.ComponentProps<typeof MenuGroup>;
interface MenuGroupProps {
    /** A heading grouping the menu items. */
    title?: ImpMenuGroupProps["title"];
    /** An accessibility label for the group. */
    "aria-label"?: ImpMenuGroupProps["aria-label"];
}
declare type ImpMenuTriggerProps = React.ComponentProps<typeof MenuTrigger>;
interface MenuTriggerProps {
    slot?: ImpMenuTriggerProps["slot"];
    /** The element to trigger opening the menu and the menu itself.
  The trigger should be an element that supports press events */
    children: ImpMenuTriggerProps["children"];
}
declare type ImpNoticeProps = React.ComponentProps<typeof Notice>;
interface NoticeProps {
    slot?: ImpNoticeProps["slot"];
    type?: ImpNoticeProps["type"];
}
declare type ImpRadioProps = React.ComponentProps<typeof Radio>;
interface RadioProps {
    form?: ImpRadioProps["form"];
    slot?: ImpRadioProps["slot"];
    defaultChecked?: ImpRadioProps["defaultChecked"];
    className?: ImpRadioProps["className"];
    id?: ImpRadioProps["id"];
    tabIndex?: ImpRadioProps["tabIndex"];
    onChange?: ImpRadioProps["onChange"];
    required?: ImpRadioProps["required"];
    value?: ImpRadioProps["value"];
    /** Visually hides the specified elements. The hidden elements will still be present and visible to screen readers. */
    hiddenElements?: ImpRadioProps["hiddenElements"];
    /** Descriptive text that will be rendered adjacent to the control's label. */
    description?: ImpRadioProps["description"];
    /** Error text that will be rendered below the control. */
    error?: ImpRadioProps["error"];
    /** ref that attaches to the outermost element of the control. */
    outerRef?: ImpRadioProps["outerRef"];
    /** Text that describes the control. Will be both visible and clickable. */
    label?: ImpRadioProps["label"];
    /** Text that describes the control. Only visible to screen readers, and is not clickable. Should not be used if `label` is set. */
    "aria-label"?: ImpRadioProps["aria-label"];
    /** Sets whether or the Radio is checked or not, for controlled use cases. Should be used in conjunction with `onClick`. */
    checked?: ImpRadioProps["checked"];
    /** Used to collect multiple Radios into a single, mutually exclusive group, for uncontrolled use cases. */
    name?: ImpRadioProps["name"];
    /** Sets whether or not the Radio should be disabled. Prevents toggling in both controlled and uncontrolled situations. */
    disabled?: ImpRadioProps["disabled"];
    /** Sets whether or not the element is in an invalid state. */
    invalid?: ImpRadioProps["invalid"];
}
declare type ImpSelectProps = React.ComponentProps<typeof Select>;
interface SelectProps {
    form?: ImpSelectProps["form"];
    slot?: ImpSelectProps["slot"];
    defaultValue?: ImpSelectProps["defaultValue"];
    name?: ImpSelectProps["name"];
    multiple?: ImpSelectProps["multiple"];
    required?: ImpSelectProps["required"];
    /** Visually hides the specified elements. The hidden elements will still be present and visible to screen readers. */
    hiddenElements?: ImpSelectProps["hiddenElements"];
    /** Descriptive text that will be rendered adjacent to the control's label. */
    description?: ImpSelectProps["description"];
    /** Error text that will be rendered below the control. */
    error?: ImpSelectProps["error"];
    /** ref that attaches to the outermost element of the control. */
    outerRef?: ImpSelectProps["outerRef"];
    /** Text that describes the control. Will be both visible and clickable. */
    label?: ImpSelectProps["label"];
    /** Text that describes the control. Only visible to screen readers, and is not clickable. Should not be used if `label` is set. */
    "aria-label"?: ImpSelectProps["aria-label"];
    /** Sets the Select's value, for controlled use cases. Should be used in conjunction with `onChange`. */
    value?: ImpSelectProps["value"];
    /** Function to call when the element's value changes. */
    onChange?: ImpSelectProps["onChange"];
    /** Sets whether or not the element should be disabled. Prevents selection. */
    disabled?: ImpSelectProps["disabled"];
    /** Displays the component that indicates that the value is invalid */
    invalid?: ImpSelectProps["invalid"];
    /** The size of the select control */
    size?: ImpSelectProps["size"];
}
declare type ImpSwitchProps = React.ComponentProps<typeof Switch>;
interface SwitchProps {
    form?: ImpSwitchProps["form"];
    slot?: ImpSwitchProps["slot"];
    defaultChecked?: ImpSwitchProps["defaultChecked"];
    className?: ImpSwitchProps["className"];
    id?: ImpSwitchProps["id"];
    tabIndex?: ImpSwitchProps["tabIndex"];
    name?: ImpSwitchProps["name"];
    required?: ImpSwitchProps["required"];
    value?: ImpSwitchProps["value"];
    /** Visually hides the specified elements. The hidden elements will still be present and visible to screen readers. */
    hiddenElements?: ImpSwitchProps["hiddenElements"];
    /** Descriptive text that will be rendered adjacent to the control's label. */
    description?: ImpSwitchProps["description"];
    /** Error text that will be rendered below the control. */
    error?: ImpSwitchProps["error"];
    /** ref that attaches to the outermost element of the control. */
    outerRef?: ImpSwitchProps["outerRef"];
    /** Text that describes the control. Will be both visible and clickable. */
    label?: ImpSwitchProps["label"];
    /** Text that describes the control. Only visible to screen readers, and is not clickable. Should not be used if `label` is set. */
    "aria-label"?: ImpSwitchProps["aria-label"];
    /** Sets whether or the element is checked or not, for controlled use cases. Should be used in conjunction with `onChange`. */
    checked?: ImpSwitchProps["checked"];
    /** Sets whether or not the element should be disabled. Prevents toggling in both controlled and uncontrolled situations. */
    disabled?: ImpSwitchProps["disabled"];
    /** Function to call when the element's value changes. Will not fire if the element is disabled. */
    onChange?: ImpSwitchProps["onChange"];
    /** Sets whether or not the element is in an invalid state. This is a display-only prop, and will not prevent form submission. */
    invalid?: ImpSwitchProps["invalid"];
}
declare type ImpTableProps = React.ComponentProps<typeof Table>;
interface TableProps {
    slot?: ImpTableProps["slot"];
}
declare type ImpTableHeadProps = React.ComponentProps<typeof TableHead>;
interface TableHeadProps {
    slot?: ImpTableHeadProps["slot"];
}
declare type ImpTableBodyProps = React.ComponentProps<typeof TableBody>;
interface TableBodyProps {
    slot?: ImpTableBodyProps["slot"];
}
declare type ImpTableRowProps = React.ComponentProps<typeof TableRow>;
interface TableRowProps {
    slot?: ImpTableRowProps["slot"];
}
declare type ImpTableFooterProps = React.ComponentProps<typeof TableFooter>;
interface TableFooterProps {
    slot?: ImpTableFooterProps["slot"];
}
declare type ImpTableCellProps = React.ComponentProps<typeof TableCell>;
interface TableCellProps {
    slot?: ImpTableCellProps["slot"];
    align?: ImpTableCellProps["align"];
    colSpan?: ImpTableCellProps["colSpan"];
    contentUses?: ImpTableCellProps["contentUses"];
    minWidth?: ImpTableCellProps["minWidth"];
    maxWidth?: ImpTableCellProps["maxWidth"];
    rowSpan?: ImpTableCellProps["rowSpan"];
    vAlign?: ImpTableCellProps["vAlign"];
    width?: ImpTableCellProps["width"];
    wrap?: ImpTableCellProps["wrap"];
}
declare type ImpTableHeaderCellProps = React.ComponentProps<typeof TableHeaderCell>;
interface TableHeaderCellProps {
    slot?: ImpTableHeaderCellProps["slot"];
    align?: ImpTableHeaderCellProps["align"];
    colSpan?: ImpTableHeaderCellProps["colSpan"];
    contentUses?: ImpTableHeaderCellProps["contentUses"];
    minWidth?: ImpTableHeaderCellProps["minWidth"];
    maxWidth?: ImpTableHeaderCellProps["maxWidth"];
    rowSpan?: ImpTableHeaderCellProps["rowSpan"];
    vAlign?: ImpTableHeaderCellProps["vAlign"];
    width?: ImpTableHeaderCellProps["width"];
    wrap?: ImpTableHeaderCellProps["wrap"];
}
interface TabProps {
}
interface TabPanelProps {
}
declare type ImpTextAreaProps = React.ComponentProps<typeof TextArea>;
interface TextAreaProps {
    form?: ImpTextAreaProps["form"];
    slot?: ImpTextAreaProps["slot"];
    defaultValue?: ImpTextAreaProps["defaultValue"];
    className?: ImpTextAreaProps["className"];
    id?: ImpTextAreaProps["id"];
    placeholder?: ImpTextAreaProps["placeholder"];
    tabIndex?: ImpTextAreaProps["tabIndex"];
    onChange?: ImpTextAreaProps["onChange"];
    name?: ImpTextAreaProps["name"];
    disabled?: ImpTextAreaProps["disabled"];
    required?: ImpTextAreaProps["required"];
    value?: ImpTextAreaProps["value"];
    wrap?: ImpTextAreaProps["wrap"];
    cols?: ImpTextAreaProps["cols"];
    /** Visually hides the specified elements. The hidden elements will still be present and visible to screen readers. */
    hiddenElements?: ImpTextAreaProps["hiddenElements"];
    /** Descriptive text that will be rendered adjacent to the control's label. */
    description?: ImpTextAreaProps["description"];
    /** Error text that will be rendered below the control. */
    error?: ImpTextAreaProps["error"];
    /** ref that attaches to the outermost element of the control. */
    outerRef?: ImpTextAreaProps["outerRef"];
    /** Text that describes the control. Will be both visible and clickable. */
    label?: ImpTextAreaProps["label"];
    /** Text that describes the control. Only visible to screen readers, and is not clickable. Should not be used if `label` is set. */
    "aria-label"?: ImpTextAreaProps["aria-label"];
    /** Programmatically mark the value as invalid */
    invalid?: ImpTextAreaProps["invalid"];
    /** The size of the input */
    size?: ImpTextAreaProps["size"];
    /** Allow the user to resize the textarea */
    resizeable?: ImpTextAreaProps["resizeable"];
    /** Rows of text that are visible in the input */
    rows?: ImpTextAreaProps["rows"];
}
declare type ImpTextFieldProps = React.ComponentProps<typeof TextField>;
interface TextFieldProps {
    form?: ImpTextFieldProps["form"];
    slot?: ImpTextFieldProps["slot"];
    pattern?: ImpTextFieldProps["pattern"];
    defaultValue?: ImpTextFieldProps["defaultValue"];
    className?: ImpTextFieldProps["className"];
    id?: ImpTextFieldProps["id"];
    placeholder?: ImpTextFieldProps["placeholder"];
    tabIndex?: ImpTextFieldProps["tabIndex"];
    onChange?: ImpTextFieldProps["onChange"];
    name?: ImpTextFieldProps["name"];
    disabled?: ImpTextFieldProps["disabled"];
    required?: ImpTextFieldProps["required"];
    value?: ImpTextFieldProps["value"];
    /** Visually hides the specified elements. The hidden elements will still be present and visible to screen readers. */
    hiddenElements?: ImpTextFieldProps["hiddenElements"];
    /** Descriptive text that will be rendered adjacent to the control's label. */
    description?: ImpTextFieldProps["description"];
    /** Error text that will be rendered below the control. */
    error?: ImpTextFieldProps["error"];
    /** ref that attaches to the outermost element of the control. */
    outerRef?: ImpTextFieldProps["outerRef"];
    /** Text that describes the control. Will be both visible and clickable. */
    label?: ImpTextFieldProps["label"];
    /** Text that describes the control. Only visible to screen readers, and is not clickable. Should not be used if `label` is set. */
    "aria-label"?: ImpTextFieldProps["aria-label"];
    /** Programmatically mark the value as invalid */
    invalid?: ImpTextFieldProps["invalid"];
    /** The size of the input */
    size?: ImpTextFieldProps["size"];
    /** Choose between the text-alike types on an input */
    type?: ImpTextFieldProps["type"];
}
declare type ImpListItemProps = React.ComponentProps<typeof ListItem>;
interface ListItemProps {
    /** The value to display on the right-hand side of the item */
    value?: ImpListItemProps["value"];
    /** Rendered contents of the item */
    children?: ImpListItemProps["children"];
    /** The id of the item. This will be passed into the `onAction` handler of `List` */
    id?: ImpListItemProps["id"];
}
declare type ImpListProps = React.ComponentProps<typeof List>;
interface ListProps {
    slot?: ImpListProps["slot"];
    /** Press event handler which receives the corresponding key of the list item that was pressed */
    onAction?: ImpListProps["onAction"];
}
export { BadgeProps, ButtonGroupProps, ButtonProps, CheckboxProps, DividerProps, FormFieldGroupProps, LinkProps, ListItemProps, ListProps, MenuGroupProps, MenuItemProps, MenuProps, MenuTriggerProps, NoticeProps, RadioProps, SelectProps, StylableProps, SwitchProps, TabPanelProps, TabProps, TableBodyProps, TableCellProps, TableFooterProps, TableHeadProps, TableHeaderCellProps, TableProps, TableRowProps, TextAreaProps, TextFieldProps };
