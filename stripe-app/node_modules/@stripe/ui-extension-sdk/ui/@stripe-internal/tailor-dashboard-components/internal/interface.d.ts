...
interface Props$2 {
    ...
    externalLink?: {
        ...
        label: string;
        /**
         * The URL that is opened in a new window when
...
/** @external */
declare const ContextView: (props: Props$2) => JSX.Element;
...
declare type Merge$1<P1, P2> = Omit<P1, DistributiveKeyof<P2>> & P2;
...
declare type CssTokens<T> = {
    assign(values: CssPartialTokenRecord<T, string | number>): Intent;
...
declare type CssProperties = {
    [K in keyof Properties]: CssValue<Exclude<Properties[K], undefined>>;
} & {
    [customProperty: `--${string}`]: CssValue<string | number> | undefined;
};
...
declare type CssNestedProperties<T> = T & {
    [selector: CssSelector]: CssNestedProperties<T>;
};
...
declare type InstanceProps<Props, Instance> = Merge$1<SharedProps & (Instance extends keyof JSX.IntrinsicElements ? JSX.IntrinsicElements[Instance] : DefaultInstanceProps), Props>;
...
declare type RemoveIntents<T, Props> = T extends Intent ? never : T extends Intent<Props> ? never : T;
...
declare type PropsShape<Props, MergedProps> = MergedProps & {
    uses?: (Intent | Intent<Props> | Partial<MergedProps>)[];
};
interface ExternalComponent<Props, MergedProps> {
    <P extends PropsShape<Props, MergedProps>>(props: P & {
        [K in DistributiveKeyof<FlattenProps<P, Props>> as K extends DistributiveKeyof<MergedProps & {
            [data: `data-${string}`]: string | boolean | number | undefined;
        }> ? never : K]: never;
    }): JSX.Element;
}
declare type Serializer<ComputedProperties> = CssSerializer<{}, {}, {}, {}, {}, ComputedProperties>;
 ...
 * @param value
 */
declare const Button: Component<ButtonProps, "a", undefined, CssComputeProperties<{
    pointer: {
        coarse: string;
        fine: string;
        none: string;
    ...
    font: CssPlugin<"caption" | "body" | "title" | "heading" | "subtitle" | "subheading" | "lead" | "kicker" | "bodyEmphasized" | CssValue<Property.Font> | undefined, CssProperties>;
    alignSelfX: (value: AlignX) => {
        '--align-self-x'?: CssValue<string> | undefined;
    };
    alignSelfY: (value: AlignY) => {
        '--align-self-y'?: CssValue<string> | undefined;
    };
    alignX: (value: AlignX) => {
        '--align-x'?: CssValue<string> | undefined;
    };
    alignY: (value: AlignY) => {
        '--align-y'?: CssValue<string> | undefined;
    };
    topShadow: ShadowPlugin;
    focusRing: ShadowPlugin;
    keyline: ShadowPlugin;
    keylineWidth: (val: CssValue<Property.BorderWidth<0 | (string & {})>> | undefined) => {
        [key: `--${string}`]: CssValue<Property.BorderWidth<0 | (string & {})>> | undefined;
    };
    marginX: (value: CssValue<Property.MarginLeft<0 | (string & {})>> | undefined) => Pick<CssProperties, "marginLeft" | "marginRight">;
    marginY: (value: CssValue<Property.MarginTop<0 | (string & {})>> | undefined) => Pick<CssProperties, "marginBottom" | "marginTop">;
    paddingX: (value: CssValue<Property.PaddingLeft<0 | (string & {})>> | undefined) => Pick<CssProperties, "paddingLeft" | "paddingRight">;
    paddingY: (value: CssValue<Property.PaddingTop<0 | (string & {})>> | undefined) => Pick<CssProperties, "paddingBottom" | "paddingTop">;
}, {
    color: {
        neutral0: string;
        neutral50: string;
...
}, Omit<Omit<{}, "backgroundColor" | "borderColor" | "zIndex" | "color" | "left" | "right" | "bottom" | "top" | "inset" | "fill" | "borderBottomColor" | "borderBottomLeftRadius" | "borderBottomRightRadius" | "borderLeftColor" | "borderRightColor" | "borderTopColor" | "borderTopLeftRadius" | "borderTopRightRadius" | "boxShadow" | "columnGap" | "fontFamily" | "fontWeight" | "marginBottom" | "marginLeft" | "marginRight" | "marginTop" | "paddingBottom" | "paddingLeft" | "paddingRight" | "paddingTop" | "rowGap" | "padding" | "background" | "borderRadius" | "gap" | "margin" | "topShadow" | "focusRing" | "keyline" | "marginX" | "marginY" | "paddingX" | "paddingY"> & {
    zIndex: "zIndex";
    fontFamily: "typeface";
    fontWeight: "weight";
    marginX: "space";
...
interface Props$1 {
     ...
     * @external
     */
    primaryAction?: ReactElement<typeof Button>;
    /**
     * A secondary call to action ("Cancel") button placed in the footer.
     * @external
     */
    secondaryAction?: ReactElement<typeof Button>;
    /**
    ...
    shown?: boolean;
    /**
     * If the user clicks out of the FocusView or presses the escape button,
     * this informs the extension that the user has closed the view.
     * @external
     */
    onClose?: () => void;
    /**
...
/** @external */
declare const FocusView: (props: Props$1) => JSX.Element;
interface Props {
    /**
     * If provided, there will be a sticky footer rendered with
     * a "Save" button in the App Drawer.
...
declare type ImpContextViewProps = React.ComponentProps<typeof ContextView>;
interface ContextViewProps {
    /** The title of the ContextView. This will be displayed at the top
  of the drawer under that app's name. */
    title: ImpContextViewProps["title"];
    /** A description of the view's purpose, can also be used as a subtitle. */
    description?: ImpContextViewProps["description"];
    /** A link to an external webpage. This should generally allow the user to
  view related information on another site with more context than what
  the app makes available in the app drawer. */
    externalLink?: ImpContextViewProps["externalLink"];
    /** A React fragment containing up to three Buttons that will be displayed
  directly under the header and above the children of the ContextView. */
    actions?: ImpContextViewProps["actions"];
    /** The contents of the ContextView. */
    children?: ImpContextViewProps["children"];
}
declare type ImpFocusViewProps = React.ComponentProps<typeof FocusView>;
interface FocusViewProps {
    /** The title of the FocusView. This will be displayed at the top
  of the drawer under your app's name. */
    title: ImpFocusViewProps["title"];
    /** A primary call to action ("Save" or "Continue") button placed in the footer. */
    primaryAction?: ImpFocusViewProps["primaryAction"];
    /** A secondary call to action ("Cancel") button placed in the footer. */
    secondaryAction?: ImpFocusViewProps["secondaryAction"];
    /** React node adjacent to any actions in the footer. */
    footerContent?: ImpFocusViewProps["footerContent"];
    /** Whether the FocusView should be shown or not. This property is maintained by a parent view. */
    shown?: ImpFocusViewProps["shown"];
    /** If the user clicks out of the FocusView or presses the escape button,
  this informs the extension that the user has closed the view. */
    onClose?: ImpFocusViewProps["onClose"];
    /** The contents of the FocusView. */
    children: ImpFocusViewProps["children"];
}
declare type ImpSettingsViewProps = React.ComponentProps<typeof SettingsView>;
interface SettingsViewProps {
    /** If provided, there will be a sticky footer rendered with
  a "Save" button in the App Drawer.
  This callback will be called when the button is clicked. */
    onSave: ImpSettingsViewProps["onSave"];
    /** A string to display a status such as "Saved" or "Error"
  in the footer of the view. */
    statusMessage?: ImpSettingsViewProps["statusMessage"];
    /** The contents of the SettingsView, usually a Form or some
  other content surrounding a form. */
    children: ImpSettingsViewProps["children"];
}
export { ContextViewProps, FocusViewProps, SettingsViewProps };
